...
class STLS1(object):
    ...
    def create_stream_l2_401 (self):
        #td_isg = self.time_delay * 1000000.0
        size = self.fsize - 4;
        #generating 5tuple flows with 802.1p =0 and dscp = be (00, tos = 0), should be dropped
        base_pkt =  Ether()/Dot1Q(vlan=41)/IP(src="10.40.0.1", dst = "10.41.0.1")/UDP(sport=1025,dport=12)
